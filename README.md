...
Submitted by: **Diego Lopez**

Deployed Application (**required**): [Kudos Board Deployed Site](https://project-week3-nbs9.onrender.com/)
...
- [x] **Add New Board**
  ...
  - [x] When creating a new board, users can specify the: -[x] Title (required)
    - [x] Category (required)
    - [x] Author (optional)
...
Of coursew they did I wouldn't have been able to do any backend without the labs

- If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.

Add validation to my backend enpoints, and probably do everything more pretty

- Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

I finished all the stretch features even when I thought I wasn't going to be able to
